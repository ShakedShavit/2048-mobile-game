...
import { endOnGoingGameActionType, initiateGameActionType, moveActionType } from "../actions/game";
...
const gameReducer = (state = initialGameState, action) => {
    switch (action.type) {
        case initiateGameActionType:
            ...
            game.board = addRandomSquareToMatrix(game.board, game.boardSquareValOptionsArr);
            return {
                game,
                hasStarted: true,
                score: 0,
