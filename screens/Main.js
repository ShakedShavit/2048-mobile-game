...
import { endOnGoingGameAction, initiateGameAction } from "../store/actions/game";
import appColors from "../constants/Colors";

export default function Main() {
    const [rowCount, setRowCount] = useState("");
    const [columnCount, setColumnCount] = useState("");
    const [gameStartedBackground, setGameStartedBackground] = useState(appColors.orange);
        ...
        <View style={styles.container}>
            ...
            {!!gameState.hasStarted && (
                <View style={styles.scoreContainer}>
                    <Text style={styles.scoreText}>{gameState.hasLost ? "Lost" : "Score:"}</Text>
                    {!gameState.hasLost && <Text style={styles.scoreText}>{gameState.score}</Text>}
                </View>
            )}
