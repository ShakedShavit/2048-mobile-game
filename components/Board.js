...
export default function Board() {
  ...
  const boardTouchEndHandler = (e) => {
    ...
    else if (xPosDiff < swipeDiff && isXAbsDiffBigger)
      swipe(directionsEnum.right);
    else if (yPosDiff > swipeDiff && !isXAbsDiffBigger)
      swipe(directionsEnum.up);
    else if (yPosDiff < swipeDiff && !isXAbsDiffBigger)
      swipe(directionsEnum.down);
  };
  ...
  useEffect(() => {
    ...
    // console.log("\n");
    // gameState.game.board.forEach((row) => {
    //   let rowStr = "";
    //   row.forEach((column) => {
    //     if (column === null) rowStr += " /";
    //     else rowStr += " " + column.value;
    //   });
    //   console.log(rowStr);
    // });
    // console.log("\n");
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* {gameState.hasStarted &&
          !!gameState.game &&
          gameState.game.board.map((row, i) => {
